...
import com.java6ASM.dto.ProductCategoryCount;
...
//	List<Product> findProductDetailType(@Param("id") int idCategory);
	...
	@Query("select new ProductCategoryCount( o.category.name, count(o)) from Product o group by o.category.id, o.category.name")
...
//	@Query("SELECT new thanhphuc.asmjava5.dto.Report(o.category, sum(o.price), count(o)) "
//			+ " FROM Product o "
//			+ " GROUP BY o.category"
